...
class MOD_Usuario(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
                    ...
                    try:
                        with mysql.connector.connect(host='localhost', user='root', password='admin', db='Jardineria') as conexion:
                            with conexion.cursor() as cursor:
                                ...
                                valores = (Seña,Responsable,Rol,Correo,correo_control)
                                cursor.execute(consulta,valores)
                                # Confirmar los cambios en la base de datos
                                conexion.commit()
                                # Mostrar mensaje de éxito
        ...
        Entrada_Status.place(x=120,y=200)
        #Botones
...
class MOD_Movimiento(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
                ...
                try:
                    with mysql.connector.connect(host='localhost', user='root', password='admin', db='Jardineria') as conexion:
                        with conexion.cursor() as cursor:
                            ...
                            print('Inventario ----------------------',InventarioAnterior[0][0])
        ...
        Boton_Estadistica6 = ctk.CTkButton(self,command=estadistica6,font=font1,border_color='#68462b',border_width=3,text_color='#fff',text='Estadísticas',fg_color='#B964D9',hover_color='#9450AD',bg_color='#91a398',cursor='hand2',corner_radius=15,width=260)
...
class CON_Movimiento(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Boton_Estadisticas = ctk.CTkButton(self,command=estadistica6,font=font1,text_color='#fff',border_color='#68462b',border_width=3,text='Estadísticas',fg_color='#59A4E2',hover_color='#3F74A1',bg_color='#91a398',cursor='hand2',corner_radius=15,width=260)
