...
class MenuPrincipal():
    ...
    def actualizacionDeventana(self):
        ...
        # Frame principal
        frame_secundario = ctk.CTkFrame(self.ventana_secundaria, fg_color='#D1F2EB', bg_color='#C0D9AF')
        ...
        estilo_boton = {'font': ('Helvetica', 16),'fg_color': '#e9e0d1','border_color':'#68462b',
                        'hover_color': '#e7d9b4','corner_radius': 12,'border_width': 3,'width': 200,'text_color':'#213635'}
...
class MenuPrincipalCol():
    ...
    def actualizacionDeventana(self):
        ...
        # Etiqueta para el titulo 
        ctk.CTkLabel(frame_secundario, text='Menu de Opciones', 
                     font=('Helvetica', 24, 'bold'), fg_color='#D1F2EB', 
                     bg_color='#C0D9AF').pack(pady=20)
...
class MOD_Usuario(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def clear_cells(*clicked):
            ...
            Entrada_Status.configure(self,show='*',placeholder_text='************',placeholder_text_color='#858585',font=font1,text_color='#000',fg_color='#CDEBFF',border_color='#68462b',border_width=3,width=180,bg_color='#D1F2EB')
        
        #Formato página
        Etiqueta_Correo = ctk.CTkLabel(self,font=font1,text='Correo:',text_color='#000',bg_color='#D1F2EB')
        Etiqueta_Correo.place(x=20,y=20)
        Entrada_Correo = ctk.CTkEntry(self,placeholder_text='example@gmail.com',placeholder_text_color='#858585',font=font1,text_color='#000',fg_color='#CDEBFF',border_color='#68462b',border_width=3,width=180,bg_color='#D1F2EB')
        Entrada_Correo.place(x=120,y=20)
        #Etiqueta_Responsable = ctk.CTkLabel(self,font=font1,text='Responsable:',text_color='#000',bg_color='#D1F2EB')
        #Etiqueta_Responsable.place(x=20,y=80)
        #Entrada_Responsable = ctk.CTkEntry(self,placeholder_text='Usuario',placeholder_text_color='#858585',font=font1,text_color='#000',fg_color='#CDEBFF',border_color='#68462b',border_width=3,width=180,bg_color='#D1F2EB')
        ...
        OpcionesRol = ctk.CTkComboBox(self,font=font1,text_color='#000',fg_color='#CDEBFF',dropdown_hover_color='#68462b',border_width=3,button_color='#68462b',button_hover_color='#0C9295',border_color='#68462b',width=180,variable=variable1,values=options,state='readonly',bg_color='#D1F2EB')
        ...
        Entrada_Status = ctk.CTkEntry(self,show='*',placeholder_text='************',placeholder_text_color='#858585',font=font1,text_color='#000',fg_color='#CDEBFF',border_color='#68462b',border_width=3,width=180,bg_color='#D1F2EB')
        Entrada_Status.place(x=120,y=140)
        #Botones
        Boton_Agregar = ctk.CTkButton(self,command=insertar,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Añadir Usuario',fg_color='#74DCAE',hover_color='#5AA986',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Agregar.place(x=20,y=310)
        Boton_Limpiar = ctk.CTkButton(self,command=lambda:clear_cells(True),font=font1,border_color='#68462b',border_width=3,text_color='#CDEBFF',text='Limpiar',fg_color='#8E6537',hover_color='#78552D',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Limpiar.place(x=20,y=360)
        Boton_modificar = ctk.CTkButton(self,command=actualizar,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Modificar',fg_color='#59A4E2',hover_color='#3F74A1',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_modificar.place(x=300,y=360)
        Boton_borrar = ctk.CTkButton(self,command=eliminar_dato,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Eliminar',fg_color='#EC5B5B',hover_color='#A03D3D',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
...
class MOD_Producto(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        OpcionesSKU = ctk.CTkComboBox(self,font=font1,text_color='#000',fg_color='#CDEBFF',dropdown_hover_color='#68462b',border_width=3,button_color='#68462b',button_hover_color='#0C9295',border_color='#68462b',width=180,variable=variableSKU,values=optionsSKU,state='readonly',bg_color='#D1F2EB')
        ...
        Entrada_Nombre = ctk.CTkEntry(self,placeholder_text='Producto...',placeholder_text_color='#858585',font=font1,text_color='#000',fg_color='#CDEBFF',border_color='#68462b',border_width=3,width=180,bg_color='#D1F2EB')
        ...
        Entrada_Descripcion = ctk.CTkEntry(self,placeholder_text='Descripción...',placeholder_text_color='#858585',font=font1,text_color='#000',fg_color='#CDEBFF',border_color='#68462b',border_width=3,width=180,bg_color='#D1F2EB')
        ...
        #Botones
        Boton_Agregar = ctk.CTkButton(self,command=insertar,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Añadir Producto',fg_color='#74DCAE',hover_color='#5AA986',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Agregar.place(x=20,y=310)
        Boton_Limpiar = ctk.CTkButton(self,command=lambda:clear_cells(True),font=font1,border_color='#68462b',border_width=3,text_color='#CDEBFF',text='Limpiar',fg_color='#8E6537',hover_color='#78552D',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Limpiar.place(x=20,y=360)
        Boton_modificar = ctk.CTkButton(self,command=actualizar,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Modificar',fg_color='#59A4E2',hover_color='#3F74A1',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
...
class MOD_Ubicaciones(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Entrada_Nombre = ctk.CTkEntry(self,placeholder_text='Nombre...',placeholder_text_color='#858585',font=font1,text_color='#000',fg_color='#CDEBFF',border_color='#68462b',border_width=3,width=180,bg_color='#D1F2EB')
        ...
        Entrada_Descripcion = ctk.CTkEntry(self,placeholder_text='Descripcion...',placeholder_text_color='#858585',font=font1,text_color='#000',fg_color='#CDEBFF',border_color='#68462b',border_width=3,width=180,bg_color='#D1F2EB')
        ...
        #Botones
        Boton_Agregar = ctk.CTkButton(self,command=insertar,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Añadir Ubicación',fg_color='#74DCAE',hover_color='#5AA986',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Agregar.place(x=20,y=310)
        Boton_Limpiar = ctk.CTkButton(self,command=lambda:clear_cells(True),font=font1,border_color='#68462b',border_width=3,text_color='#CDEBFF',text='Limpiar',fg_color='#8E6537',hover_color='#78552D',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Limpiar.place(x=20,y=360)
        Boton_modificar = ctk.CTkButton(self,command=actualizar,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Modificar',fg_color='#59A4E2',hover_color='#3F74A1',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
...
class MOD_Inventario(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        OpcionesProducto = ctk.CTkComboBox(self,font=font1,text_color='#000',fg_color='#CDEBFF',dropdown_hover_color='#68462b',border_width=3,button_color='#68462b',button_hover_color='#0C9295',border_color='#68462b',width=180,variable=VarProducto,values=OptProducto,state='readonly',bg_color='#D1F2EB')
        ...
        OpcionesUbicaciones = ctk.CTkComboBox(self,font=font1,text_color='#000',fg_color='#CDEBFF',dropdown_hover_color='#68462b',border_width=3,button_color='#68462b',button_hover_color='#0C9295',border_color='#68462b',width=180,variable=VarUbicacion,values=OptUbicacion,state='readonly',bg_color='#D1F2EB')
        ...
        #Botones
        Boton_Agregar = ctk.CTkButton(self,command=insertar,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Añadir Segmento',fg_color='#74DCAE',hover_color='#5AA986',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Agregar.place(x=20,y=310)
        Boton_Limpiar = ctk.CTkButton(self,command=lambda:clear_cells(True),font=font1,border_color='#68462b',border_width=3,text_color='#CDEBFF',text='Limpiar',fg_color='#8E6537',hover_color='#78552D',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Limpiar.place(x=20,y=360)
        Boton_modificar = ctk.CTkButton(self,command=actualizar,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Modificar',fg_color='#59A4E2',hover_color='#3F74A1',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
...
class MOD_Movimiento(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def estadisticamerma():
            ...
            try:
                with mysql.connector.connect(**conexion_config) as conexion:
                    consulta_mermas = "SELECT t.nombre, m.fecha, m.cantidad FROM jardineria.movimiento m LEFT JOIN jardineria.tipo_producto t ON m.sku = t.sku WHERE m.fecha >= %s AND m.razon = 'Merma'"
        ...
        OpcionesRazon = ctk.CTkComboBox(self,font=font1,text_color='#000',fg_color='#CDEBFF',dropdown_hover_color='#68462b',border_width=3,button_color='#68462b',button_hover_color='#0C9295',border_color='#68462b',width=180,variable=VarRazon,values=razones,state='readonly',bg_color='#D1F2EB')
        ...
        #Botones
        Boton_Agregar = ctk.CTkButton(self,command=insertar,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Añadir Movimiento',fg_color='#74DCAE',hover_color='#5AA986',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Agregar.place(x=20,y=260)
        Boton_Limpiar = ctk.CTkButton(self,command=lambda:clear_cells(True),font=font1,border_color='#68462b',border_width=3,text_color='#CDEBFF',text='Limpiar',fg_color='#8E6537',hover_color='#78552D',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Limpiar.place(x=20,y=310)
        Boton_Estadistica6 = ctk.CTkButton(self,command=estadistica6,font=font1,border_color='#68462b',border_width=3,text_color='#CDEBFF',text='Estadística 1',fg_color='#B964D9',hover_color='#9450AD',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=110)
        Boton_Estadistica6.place(x=20,y=360)
        Boton_Estadistica = ctk.CTkButton(self,command=estadisticamerma,font=font1,border_color='#68462b',border_width=3,text_color='#CDEBFF',text='Estadística 2',fg_color='#B94EA3',hover_color='#813672',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=110)
...
class CON_Movimiento(ctk.CTkToplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Boton_Estadisticas = ctk.CTkButton(self,command=estadistica6,font=font1,text_color='#CDEBFF',border_color='#68462b',border_width=3,text='Estadística C/V',fg_color='#59A4E2',hover_color='#3F74A1',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
        Boton_Estadisticas.place(x=300,y=360)
        Boton_Estadistica2 = ctk.CTkButton(self,command=estadisticamerma,font=font1,border_color='#68462b',border_width=3,text_color='#CDEBFF',text='Estadística Merma',fg_color='#B964D9',hover_color='#9450AD',bg_color='#D1F2EB',cursor='hand2',corner_radius=15,width=260)
